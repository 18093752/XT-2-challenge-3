...
"5":{name:"Oceania",states: ["AU","MY","NZ","PH","PG","BN","SB", "TT", "VU", "NR","FJ","ID"]}
...
fetch("https://ws.audioscrobbler.com/2.0/?method=geo.gettopartists&country=spain&limit=3&api_key=4853cb54b551dbb3a43d5dc5470de465&format=json")
      .then(response => {
	console.log(response.status)
      return response.json()
})
.then(data => {console.log(data)
	      topartists1 = [data.artist[0].name,data.artist[1].name,data.artist[2].name]
